...
import 'package:flutter_plant_application/screens/detail_screen.dart';
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              onTap: (){
                Navigator.push(context, PageTransition(type: PageTransitionType.bottomToTop, child: DetailScreen(plantId: _favoratedPlants[index].plantId,)));
              },
              child: Container(
